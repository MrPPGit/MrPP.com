...
namespace MrPP.Helper
{
    ...
    /// </summary>
    public class MrPPAxisController : MonoBehaviour
    {
        /// <summary>
        ...
        public MrPPButtonController.ButtonType buttonType = MrPPButtonController.ButtonType.None;
 ...
 //           Destroy(this);
            ...
            {
                if (this.buttonType == MrPPButtonController.ButtonType.Control)
                {
                    this.buttonType = MrPPButtonController.ButtonType.Left;
                    Debug.LogWarning("Running under Remote Desktop, so changed AxisContol method to Left mouse button");
                }
                if (this.buttonType == MrPPButtonController.ButtonType.Alt)
                {
                    this.buttonType = MrPPButtonController.ButtonType.Right;
                    Debug.LogWarning("Running under Remote Desktop, so changed AxisContol method to Right mouse button");
                }
                if (this.buttonType == MrPPButtonController.ButtonType.Shift)
                {
                    this.buttonType = MrPPButtonController.ButtonType.Middle;
        ...
        {
            if (this.buttonType <= MrPPButtonController.ButtonType.Middle)
            {
                // if mouse button is either left, right or middle
                SetWantsMouseJumping(true);
            }
            else if (this.buttonType <= MrPPButtonController.ButtonType.Focused)
            {
        ...
        public bool ShouldControl()
        {
            ...
            else if (this.buttonType == MrPPButtonController.ButtonType.None)
            {
                return true;
            }
            else if (this.buttonType <= MrPPButtonController.ButtonType.Middle)
            {
                return Input.GetMouseButton((int)this.buttonType);
            }
            else if (this.buttonType == MrPPButtonController.ButtonType.Control)
            {
                return Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.RightControl);
            }
            else if (this.buttonType == MrPPButtonController.ButtonType.Shift)
            {
                return Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift);
            }
            else if (this.buttonType == MrPPButtonController.ButtonType.Alt)
            {
                return Input.GetKey(KeyCode.LeftAlt) || Input.GetKey(KeyCode.RightAlt);
            }
            else if (this.buttonType == MrPPButtonController.ButtonType.Space)
            {
                return Input.GetKey(KeyCode.Space);
            }
            else if (this.buttonType == MrPPButtonController.ButtonType.Return)
            {
            ...
            else if (this.buttonType == MrPPButtonController.ButtonType.Focused)
            {
                if (!this.usingMouse)
                {
                    ...
                    return Input.GetMouseButtonDown((int)MrPPButtonController.ButtonType.Left)
                        || Input.GetMouseButtonDown((int)MrPPButtonController.ButtonType.Right)
                        || Input.GetMouseButtonDown((int)MrPPButtonController.ButtonType.Middle);
                }
                else
                {

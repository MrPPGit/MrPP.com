...
namespace MrPP.Helper
{
    ...
    /// </summary>
    [RequireComponent(typeof(BoxCollider), typeof(MrPPInterpolator))]
    public class MrPPSimpleTagalong : MonoBehaviour
    {
        ...
        // transform.position.
        protected MrPPInterpolator interpolator;
        ...
        protected virtual void Start()
        {
            ...
            interpolator = gameObject.GetComponent<MrPPInterpolator>();
